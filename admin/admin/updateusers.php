            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">modifer ou supprime clinet</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="index.php">tableaux de bord</a></li>
                            <li class="breadcrumb-item active">modifer ou supprime clinet</li>
                        </ol>
       
  
  <form method="post" action='updateusers1.php'> 
  <tr>
  <div class="form-group">
    <td>
    <input type="text" class="form-control" name="id" placeholder="id user" ></td>
  </div></tr>
  <tr>
  <div class="form-group">
    <td>
    <input type="text" class="form-control" name="n" placeholder="username"  ></td>
  </div></tr>
      <tr>
  <div class="form-group">
  <TD>  
    <input type="text" class="form-control" name="mail" placeholder="mail"  ></td>
  </div></tr>
  
  <div class="form-group">
    <td>
   <input type="text" class="form-control" name="type" placeholder="type(user/admin)"  ></td>
  </div></tr>
  <tr>
  <div class="form-group">
    <TD>
   <input type="text" class="form-control" name="psw" placeholder="mot de passe"  ></td>
  </div></tr>
</table>
<br>
<br>
