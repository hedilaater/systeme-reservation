            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Ajouter users</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="index.php">tableaux de bord</a></li>
                            <li class="breadcrumb-item active">Ajouter users</li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-body">
  
<form class="box" action="insertu1.php" method="post">
	<input type="text" class="box-input" name="username" placeholder="Nom d'utilisateur" size='100%' >
    <br>
    <input type="text" class="box-input" name="email" placeholder="Email" size='100%' >
    <br>
	<div class="input-group">
    ...
    <input type="password" class="box-input" name="password" placeholder="Mot de passe" size='100%'>
    <br>
