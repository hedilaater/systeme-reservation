...
<html lang="en">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                            <form method="post" action='updateclinet1.php'>
  <tr>
  <div class="form-group">
    <td>
    <input type="text" class="form-control" name="i" placeholder="id client" ></td>
  </div></tr>
  <tr>
  <div class="form-group">
    <td>
  ...
  <div class="form-group">
    <td>
    <input type="text" class="form-control" name="nom"  placeholder="username"></td>
  </div></tr>
