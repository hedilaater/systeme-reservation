...
<html lang="en">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Ajouter livre</h1>
  ...
  <div class="form-group">
   <td> <input type="text" class="form-control" name="a"  placeholder="auteure de  livre"></td>
  </div></tr>
  <tr>
  <div class="form-group">
  <td> <input type="text" class="form-control" name="nb"  placeholder="date de sortie "></td>
   <td> <input type="date" class="form-control" name="d"  placeholder="date de sortie "></td>
  </div></tr>
  <tr>
  <div class="form-group">
   <td> <input type="text" class="form-control" name="nb"  placeholder="prix de  livre"></td>
  </div></tr>
  <tr>
  <div class="form-group">
				    	  <label for="inputdefault">image de livre:</label>
					      <input class="form-control" id="inputdefault" name="bP" type="file">
					    </div></tr>
</table>
<center> <button type="submit" class="btn btn-primary">ajout</button></center>
</form><br>
                            </div>
                        </div>
